        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-primary-light mb-4">
              Tu hogar reluciente en Madrid y Aranjuez. Servicios profesionales de limpieza por horas 
              para limpieza de casas, limpieza de obras, limpieza post-obra, oficinas y más. Profesionales certificados con materiales incluidos.
            </p>
