      ...
      {variant === 'full' ? (
        ...
        >
          <g>
            ...
            <path fill="#fff" d="M76.54,27.03v-3.87h.75v3.21h1.98v.66h-2.73Z"/>
            <path fill="#fff" d="M79.73,27.03v-3.87h.75v3.87h-.75Z"/>
            <path fill="#fff" d="M84.45,27.03v-2.56l-1,1.91h-.41l-1-1.91v2.56h-.75v-3.87h.81l1.15,2.2,1.16-2.2h.8v3.87h-.75Z"/>
            <path fill="#fff" d="M86.01,27.03v-3.87h1.64c.18,0,.34.04.49.11.15.07.28.17.39.29.11.12.19.26.26.41.06.15.09.31.09.47s-.03.32-.09.48-.14.29-.25.41c-.11.12-.23.22-.38.29s-.31.11-.49.11h-.92v1.3h-.75ZM86.77,25.08h.87c.14,0,.25-.06.35-.17.09-.11.14-.27.14-.46,0-.1-.01-.19-.04-.26s-.07-.14-.11-.2-.1-.1-.17-.12-.13-.04-.19-.04h-.84v1.25Z"/>
            <path fill="#fff" d="M89.42,27.03v-3.87h.75v3.87h-.75Z"/>
            <path fill="#fff" d="M93.67,26.37v.66h-2.69v-3.87h2.64v.66h-1.89v.93h1.63v.61h-1.63v1.01h1.94Z"/>
            <path fill="#fff" d="M94.02,26.47l2.19-2.64h-2.13v-.66h3v.57l-2.12,2.64h2.13v.66h-3.07v-.57Z"/>
            <path fill="#fff" d="M98.78,23.17h.67l1.47,3.87h-.78l-.36-.96h-1.35l-.35.96h-.78l1.48-3.87ZM99.65,25.54l-.54-1.52-.56,1.52h1.09Z"/>
          </g>
        </svg>
      ) : variant === 'icon' ? (
