  ...
  return (
    <>
      <SEO
        ...
        description="Descubre todos nuestros servicios de limpieza profesional en Madrid y Aranjuez: limpieza de casas, limpieza de obras, limpieza post-obra, limpieza profunda y oficinas. Precio desde 10 euros la hora para todos los servicios. Materiales incluidos. Profesionales certificados."
